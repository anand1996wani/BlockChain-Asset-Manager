 ...
 * @param {org.acme.biznet.SampleTransaction} tx The sample transaction instance.
 * @transaction
 */
function sampleTransaction(tx) {
  ...
  if(tx.type=='rented')
  {
    ...
    return getAssetRegistry('org.acme.biznet.LandAsset')
        ...
        .then(function () {
            ...
            var event = getFactory().newEvent('org.acme.biznet', 'SampleEvent');
